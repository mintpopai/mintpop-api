    ...
    <header class="border-b border-gray-200 bg-white/95 dark:border-dark-800 dark:bg-dark-900/95">
      <div class="mx-auto flex max-w-5xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        <RouterLink to="/home" class="flex min-w-0 items-center gap-3">
          ...
          <template v-else>
            <img src="https://standards.mintpop.ai/assets/brand/wordmark/mintpop-wordmark-dark.png" alt="mintpop" class="block h-7 w-auto flex-shrink-0 dark:hidden" />
            <img src="https://standards.mintpop.ai/assets/brand/wordmark/mintpop-wordmark-light.png" alt="mintpop" class="hidden h-7 w-auto flex-shrink-0 dark:block" />
          </template>
        </RouterLink>
        <RouterLink
          to="/login"
...
const siteName = computed(() => settings.value?.site_name || 'MintPop API')
